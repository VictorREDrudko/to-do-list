...
test("correct todolist should be added", () => {
  const todolist: Todolist = { id: 'any', title: "New todo", addedDate:'', order: 0 }

  const endState = todolistsReducer(startState, addTodolistAC({title: todolist.title, todolistId: todolist.id}))
